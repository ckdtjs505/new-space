      ...
      <Navbar style={{maxWidth : "90%", margin : "auto", padding : "0"}} dark expand="md">
        <NavbarBrand tag={Link} to={"/"}>New space</NavbarBrand>
          <Nav className="ml-auto" navbar>
            <NavItem>
              <NavLink tag={Link} to={"/simulation"} style={{width : "10rem",textAlign: "center" }} >우주 시뮬레이션</NavLink>
            </NavItem>
            <NavItem>
              <NavLink tag={Link} to={"/search"} style={{width : "10rem",textAlign: "center" }} >우주 검색</NavLink>
            </NavItem>
            <NavItem>
              <NavLink tag={Link} to={"/newspace"} style={{width : "10rem", color : "white", textAlign: "center" , backgroundColor : "red"}}>신우주항공</NavLink>
            </NavItem>
          </Nav>
      </Navbar>
    </div>
