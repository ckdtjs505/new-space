    ...
    <div style={{ maxWidth : "100%", backgroundColor : "black"}}>
        ...
        <Collapse isOpen={isOpen} navbar>
          <Nav className="ml-auto" navbar>
            <NavItem>
              <NavLink className ="navLink"  style={{color:"white", backgroundColor :"red"}} tag={Link} to={"/simulation"}>우주 시뮬레이션</NavLink>
            </NavItem>
            <NavItem>
              <NavLink className ="navLink" tag={Link} to={"/search"} >우주 검색</NavLink>
            </NavItem>
            <NavItem>
              <NavLink className ="navLink"  tag={Link} to={"/newspace"}>신우주항공</NavLink>
            </NavItem>
          </Nav>
        </Collapse>
      </Navbar>
