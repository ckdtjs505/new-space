        ...
        <Navbar style={{maxWidth : "90%", margin : "auto", padding : "0"}} dark expand="md">
          ...
          <Collapse isOpen={this.state.isOpen} navbar>
            <Nav className="ml-auto" navbar>
              <NavItem>
                <NavLink tag={Link} to={process.env.PUBLIC_URL + "/simulation"} style={{width : "10rem",textAlign: "center" }} >우주 시뮬레이션</NavLink>
              </NavItem>
              <NavItem>
                <NavLink tag={Link} to={process.env.PUBLIC_URL + "/search"} style={{width : "10rem", color : "white", textAlign: "center" , backgroundColor : "red"}} >우주 검색</NavLink>
              </NavItem>
              <NavItem>
